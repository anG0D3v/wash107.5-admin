...
<img className='hidden md:flex md:basis-1/2 absolute right-8 top-98 bottom-0 z-negative-10' src={jeepLogo} alt="" />
      <img className='hidden md:flex md:basis-1/2 absolute left-10 top-98 bottom-0 z-negative-10' src={jeepLogo} alt="" />
      <div className='sm:h-2/3 absolute top-1/4 left-1/4 w-4/5 sm:w-1/2 bg-gray-800 h-96  rounded-md'>
        ...
        <img className='w-32 absolute -left-7 -top-7 border-8 border-solid border-white rounded-full' src={laundryLogo} alt="" />
          <form onSubmit={handleSumbmit} className='z-10 flex flex-col items-center w-3/4 h-64 sm:h-94 absolute top-1/4 left-20 mt-4' action="">
          <h1 className="text-4xl text-charcoalBlack font-bold">Welcome!</h1>
