...
import { getInventoryPending,getInventoryFulfilled,getInventoryFailed } from '../../../Redux/InventorySlice';
  ...
  const addProduct = async () => {
    if (
      ...
      try {
        ...
        const docRef = await addData('inventoryTable',productData)
        const Inventory_Id = docRef;
        const productDatawithId = { ...productData,Inventory_Id: Inventory_Id,id: Inventory_Id, };
  ...
  return (
    <>
      ...
      <div className="text-black flex flex-col w-full justify-between h-auto">
        ...
        <h1 className="text-black text-2xl truncate font-extrabold">
          Inventory
        </h1>
